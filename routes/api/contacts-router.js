...
const { validateBody, isValidId, isValidStatus, authenticate } = require("../../decorators");
...
router.patch('/:id/favorite', authenticate, isValidStatus, validateBody(schemas.updateFavoriteSchema), contactsController.updateStatusContact);
